 ...
 <div className='overflow-y-auto  h-[calc(100vh-14rem)] thin-scrollbar'>
                ...
                <div className='flex flex-col md:flex-row '>
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        {weatherData && (
                            <div className='w-96 md:w-[700px] relative -top-5 md:top-4 md:left-44 h-[150px] rounded-3xl shadow-xl shadow-cyan-700 ml-5 md:ml-12 pt-6 bg-gray-800 flex justify-center gap-12 items-center'>
                    ...
                    <div className='w-96 md:w-[300px] relative top-2 md:top-4 md:left-44 h-64 md:h-[598px] rounded-3xl shadow-xl shadow-cyan-700 ml-5  md:ml-12 pt-6 bg-gray-800 flex flex-col justify-center md:gap-12 pl-4 text-orange-700 font-bold'>
